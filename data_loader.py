...
def load_data(emb_type='w2v', collapse_classes=False, fold=None, num_folds=1, random_state=None):
    ...
    if not check_hash(df_hash, num_folds):
        ...
        #X Concatenate features and w2vmasked_embeddings
        ...
        #X Concatenate features and bert_embeddings
        ...
        labels, bert_post_data = shuffle(labels, bert_post_data, random_state=0)
