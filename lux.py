...
for s in setup:
    ...
    try:
        for fold in range(num_folds):
            train, train_target, dev, dev_target, test, test_target, label_to_oh = load_data(emb_type=emb_type, collapse_classes=False, fold=fold, num_folds=num_folds, random_state=root)
